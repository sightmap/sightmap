	...
	return &sightmap.Corpus{
		Requests: []sightmap.RequestDef{{
			...
			Properties: []sightmap.RequestProperty{
				{Name: "outcome", Field: "rsp.body.status"},
			},
		}},
...
func TestValidate_SignalFilterShadowedReservedResolves(t *testing.T) {
	c := &sightmap.Corpus{
		Requests: []sightmap.RequestDef{{
			Name:       "R",
			Route:      "/api/x",
			Properties: []sightmap.RequestProperty{{Name: "status", Field: "rsp.body.status"}},
		}},
		Signals: []sightmap.SignalDef{{
	...
	errs := sightmap.Validate(&sightmap.Corpus{
		Views: []sightmap.View{{
			...
			Requests: []sightmap.RequestDef{{
				Name:       "ViewScoped",
				Route:      "/api/x",
				Properties: []sightmap.RequestProperty{{Name: "outcome", Field: "rsp.body.status"}},
			}},
		}},
		Signals: []sightmap.SignalDef{{

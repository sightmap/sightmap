...
| [`webmcp/`](webmcp/) | The **WebMCP codegen adapter** — compile a `.sightmap/` corpus + a tool manifest into a publishable [`document.modelContext`](https://github.com/webmachinelearning/webmcp) tool bundle for any site. |

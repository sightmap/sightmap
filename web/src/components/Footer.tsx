      ...
      <div className="container">
        <div className="footer-inner">
          ...
          <div className="footer-links">
            ...
            <a href="https://docs.sightmap.org/start/react-quickstart/">Quickstart</a>
            ...
            <a href="https://www.npmjs.com/package/@sightmap/sightmap" target="_blank" rel="noreferrer">SDK on npm</a>

...
Use the [CLI reference](/cli/overview) for commands and flags, or read the full [`sightmap-authoring` skill](https://github.com/sightmap/sightmap/blob/main/skills/sightmap-authoring/SKILL.md) for the agent playbook.

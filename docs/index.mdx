...
<Steps>
  ...
  <Step title="Let an agent iterate">
    Run `sightmap iterate <url>` for each route. The command snapshots the page and identifies unattributed interactive nodes. The agent names those components and runs it again until the view reports zero orphaned nodes.
  </Step>

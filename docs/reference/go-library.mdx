...
| `atlas` | The community atlas wire contract behind `sightmap add`: index schema, raw-URL layout, fail-closed entry validation, the HTTPS fetch policy, and the atomic `Install` operation |

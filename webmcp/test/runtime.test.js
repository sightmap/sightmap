 ...
 * jsdom against IR compiled by the Go generator
 * (`webmcp/test/fixtures/site/ir.json`, regenerated by `go generate ./webmcp/...`).
 *
...
function compiledIR() {
  return JSON.parse(JSON.stringify(require("./fixtures/site/ir.json")));
}
